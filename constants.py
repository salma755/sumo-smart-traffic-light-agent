# المسارات أصبحت نصوصاً عادية الآن
DEFAULT_SETTINGS_PATH = "settings"
MODEL_FILE = "trained_model.pt" # المسار الكامل للموديل كنص

TRAINING_SETTINGS_FILE = "training_settings.yaml"
TESTING_SETTINGS_FILE = "testing_settings.yaml"

# مسار ملف المسارات الخاص بـ SUMO
ROUTES_FILE = "intersection/episode_routes.rou.xml"

# باقي الإعدادات ثابتة كما هي
...
ACTION_TO_TL_PHASE = {0: PHASE_NS_GREEN, 1: PHASE_NSL_GREEN, 2: PHASE_EW_GREEN, 3: PHASE_EWL_GREEN}
TL_GREEN_TO_YELLOW = {
